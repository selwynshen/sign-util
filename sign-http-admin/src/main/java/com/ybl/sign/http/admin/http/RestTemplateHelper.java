 ...
 */
package com.ybl.sign.http.admin.http;
...
/**
 * @author Selwyn
 * @version $Id: RestTemplateHelper.java, v 0.1 7/8/2018 11:53 PM Selwyn Exp $
 */
@Component
public class RestTemplateHelper {
     ...
     * @return
     */
    public <R> String postForEntity(String url, R body, Object... uriVariables) {
        HttpEntity<R> request = new HttpEntity<>(body);
        ResponseEntity<String> response = restTemplate.postForEntity(url, request, String.class, uriVariables);
